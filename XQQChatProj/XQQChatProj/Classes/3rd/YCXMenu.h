...
@class YCXMenuOverlay;
@interface YCXMenu : NSObject

@property (nonatomic, strong)  YCXMenuOverlay  *  overlay;
...
@end
typedef void(^viewDidPress)(BOOL isClicked);
@interface YCXMenuOverlay : UIView
@property (nonatomic, copy)  viewDidPress   viewPress;
@end
